export default {
  template: `
    <!-- each component's <template> must have exactly one root element || there is a single div that wraps everything-->
    <div>
      ...
      <!-- New Subject Button (only visible for admin) -->
      <div class="text-center my-4" v-if="isAdmin">
            ...
            <div class="card h-100 shadow-sm">
              ...
              <div class="card-footer bg-transparent border-0 text-center">
                ...
                <div v-if="isAdmin" class="mt-2">
                  <button @click="editSubject(subject)" class="btn btn-warning btn-sm m-1">✏️ Edit</button>
                  <button @click="deleteSubject(subject.id)" class="btn btn-danger btn-sm m-1">🗑️ Delete</button>
                </div>
