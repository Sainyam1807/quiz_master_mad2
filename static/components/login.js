        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" style="height: 100vh; margin-top: 56px;">
          <div class="carousel-inner h-100">
            ...
            <div class="carousel-item h-100">
              <img src="/static/assets/img1.jpeg" class="d-block w-100 h-100" style="object-fit: cover;" alt="Quiz Slide 2">
              <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-75 p-3 rounded">
            ...
            <div class="carousel-item h-100">
              <img src="/static/assets/img1.jpeg" class="d-block w-100 h-100" style="object-fit: cover;" alt="Quiz Slide 3">
              <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-75 p-3 rounded">
