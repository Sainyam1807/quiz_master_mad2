    ...
    <tr>
      <td colspan="5" class="text-center text-muted">No questions available.</td>
              ...
              <div class="card-footer text-center">
                <button class="btn btn-info btn-sm" @click="addQuestion(quiz.id)"> Add Question</button>
                <button class="btn btn-warning btn-sm ms-2" @click="startEditQuiz(quiz)"> Edit Quiz</button>
                <button class="btn btn-danger btn-sm ms-2" @click="deleteQuiz(quiz.id)"> Delete Quiz</button>
              </div>
            </div>
          </div>
        </div>
